...
try {
  class Command {
    ...
    createManual(contents) {
      ...
      if (this.cronJobs.length > 0) {
        ret.push('📌 자동 실행 주기');
        ret.push('——');
        ret.push(...this.cronJobs.map(_ref => {
          let {
            comment
          } = _ref;
          return `· ${comment}`;
  ...
  class StructuredCommand extends Command {
    ...
    static Builder = class {
      ...
      setChannels() {
        for (var _len = arguments.length, channels = new Array(_len), _key = 0; _key < _len; _key++) {
      ...
      setExamples() {
        for (var _len2 = arguments.length, examples = new Array(_len2), _key2 = 0; _key2 < _len2; _key2++) {
          examples[_key2] = arguments[_key2];
        }
  ...
  class NaturalCommand extends Command {
    ...
    static Builder = class {
      ...
      setChannels() {
        for (var _len3 = arguments.length, channels = new Array(_len3), _key3 = 0; _key3 < _len3; _key3++) {
      ...
      setExamples() {
        for (var _len4 = arguments.length, examples = new Array(_len4), _key4 = 0; _key4 < _len4; _key4++) {
          examples[_key4] = arguments[_key4];
        }
        this.examples = examples.map(e => Array.isArray(e) ? e.map((e2, i) => i === 0 ? e2 : '╰' + '─'.repeat(i - 1) + ' ' + e2).join('\n') + '\n' : e);
        return this;
      }
    ...
    register(command, logRoom) {
      ...
      for (let idx = 0; idx < command.cronJobs.length; idx++) {
        ...
        this.cronManager.add(cron, () => {
          ...
          if (isValidChannel(logRoom)) logRoom.send(CronLog(command, idx, datetime)).then(() => {}, e => Log.e(e + '\n' + e.stack));
        }, cronOpt);
      }
    }
