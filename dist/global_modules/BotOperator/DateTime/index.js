...
class DateTime {
  ...
  humanize() {
    let ignoreTime = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : false;
  ...
  static fromString(dateString) {
    let useDuration = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : false;
    let getString = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : false;
    let filterIncludeEnding = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : true;
    let trim = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : true;
    let std = arguments.length > 5 && arguments[5] !== undefined ? arguments[5] : DateTime.now();
    let locale = arguments.length > 6 && arguments[6] !== undefined ? arguments[6] : 'ko-KR';
    return DateTime.dehumanize(dateString, useDuration, getString, filterIncludeEnding, trim, std, locale);
  }
  static dehumanize(dateString) {
    let useDuration = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : false;
    let getString = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : false;
    let filterIncludeEnding = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : true;
    let trim = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : true;
  ...
  static fromObject(datetimeObject) {
    let standard = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : undefined;
  ...
  eq(datetimeObject) {
    let ignoreMillisecond = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : false;
  ...
  static _parse(dateString) {
    let getString = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : false;
    let filterIncludeEnding = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : true;
    let trim = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : true;
    let std = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : DateTime.now();
    let locale = arguments.length > 5 && arguments[5] !== undefined ? arguments[5] : 'ko-KR';
  ...
  static parseDuration(dateString) {
    let getString = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : false;
    let filterIncludeEnding = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : true;
    let std = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : DateTime.now();
    let locale = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : 'ko-KR';
  ...
  static getWeekdayFromName(weekDayName) {
    let startOnMon = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : false;
    let locale = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 'ko-KR';
    const cultureInfo = getCultureInfo(locale);
    let W = cultureInfo['W'];
